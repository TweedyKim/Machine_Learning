...
print('|  3. String Fomat Code                                           |')
print('|  4. Format Function                                             |')
...
print('    8) Vertical Tab\v', 'Test')
print(r'    9) Escape Code print: \n  \\  \"', end='\n\n')

print('02. String Operation')
...
print('06. count() find() index() join() upper() lower() capitalize()')
...
print('    12) replace("l", "L") in "%s" is (%s)' % ((a+b+c),(a+b+c).replace("l", "L")))
